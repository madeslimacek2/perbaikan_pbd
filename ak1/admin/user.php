...
<body class="hold-transition skin-blue sidebar-mini">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<br />
							<h6 class="modal-title">#Note: Username Dan Password = NIP Dosen</h6>
						</div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<br />
							<h6 class="modal-title">#Note: Username Dan Password = NPM Mahasiswa</h6>
						</div>
						<div class="modal-body">
										...
										<select name="User_Mahasiswa" class="form-control">
											...
											while ($mhs = mysqli_fetch_array($querymahasiswa)) {
												if ($mhs["NIM"] != $_SESSION["Username"]) {
													echo "<option value='$mhs[NIM]'>$mhs[Nama_Mahasiswa], Tambah Mahasiswa untuk User dengan NPM = $mhs[NIM]</option>";
												}
											}
											?>
										</select>
	...
	<!-- Library Scripts -->
	<?php
	include "../auth/bundle_script.php";
	?>
</body>
